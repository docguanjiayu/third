function openNav() {
    var sidewidth = document.getElementById("mySidenav").style.width = "250px"
    var sideleft = document.getElementById("box").style.marginLeft = "250px"
...
let lists = ol.children//获取有序列表对象的所有子元素
